...
def expand_image(input_image_path: str, new_size: int, output_image_path: str, resize_method: int = Image.Resampling.BOX) -> None:
    """
...
def scale_sparse_matrix_image(original_matrix: sp.csr_matrix, new_size: int, resize_method: int = Image.Resampling.BOX) -> sp.csr_matrix:
    """
